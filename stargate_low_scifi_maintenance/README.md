...
- **Scheduler:** rAF-driven; while the tab is hidden *and* a sequence is in
  flight, a MessageChannel pump keeps the state machine advancing (works around
  hidden-tab timer throttling; idle hidden tabs cost nothing).
